   ...
   |cpu
      ...
      @0
         ...
         $pc = (>>1$reset) ? 32'b0 :
                     ...
                     (>>3$valid_load) ? >>3$inc_pc : (>>3$valid_jump && >>3$is_jal) ? >>3$br_tgt_pc :
                     (>>3$valid_jump && >>3$is_jalr) ? >>3$jalr_tgt_pc : 32'd4;
      ...
      @1
         ...
         $is_srl = $dec_bits ==? 11'b0_100_0110011;
      ...
      @3
         ...
         $rf_wr_data[4:0] = !$valid ? >>2$ld_data[31:0] : $result[31:0];
         ...
         $result[31:0] = $is_addi ? ($src1_value + $imm) :
                         ...
                         $is_slt ? ($src1_value[31] == $imm[31]? $sltiu_rslt : {31'b0, $src1_value[31]}):
      ...
      @5
         $ld_data[31:0] = $dmem_rd_en ? $dmem_rd_data[31:0] : 32b'0;
